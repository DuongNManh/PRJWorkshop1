        ...
        <div class="container pt-5">
            ...
            <form class="row gy-2 gx-3 align-items-center" action="MainController" method="post">
                ...
                <div class="row g-3">
                    <div class="col-sm">
                        <div class="form-floating">
                            <input type="text" class="form-control" name="mobileID"
                                   placeholder="mobileID" required="">
                    ...
                    <div class="col-sm">
                        <div class="form-floating">
                            <input type="text" class="form-control" id="mobileName" name="mobileName"
                                   placeholder="mobileName" required="">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-sm">
                        <div class="form-floating">
                            <input type="number" class="form-control" id="notSale" name="notSale"
                                   placeholder="notSale" required="" min="0">
                            <label for="notSale">Not Sale</label>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-floating">
                            <input type="number" class="form-control" id="YearOfProduction"
                                   name="YearOfProduction" placeholder="YearOfProduction" required=""
                                   min="0">
                ...
                <button class="btn btn-primary" type="submit" name="action" value="Insert">Submit
                    form</button>
            </form>
